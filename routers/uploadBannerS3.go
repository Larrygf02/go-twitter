...
func UploadBannerS3(w http.ResponseWriter, r *http.Request) {
	file, handler, _ := r.FormFile("banner")
	var extension = strings.Split(handler.Filename, ".")[1]
	var filelocation string = "images/banners/" + IdUser + "." + extension
	var s3 = models.S3
	...
	var status bool
	user.Banner = "https://" + bucket + ".s3.amazonaws.com/" + filelocation
